<%@page import="java.net.URL,java.net.URLEncoder,java.io.BufferedReader,java.io.IOException,java.io.InputStreamReader,java.io.OutputStreamWriter,java.net.URLConnection"%>
...
Business theBusiness = (Business) session.getAttribute("theBusiness");
boolean isLoggedIn = false;
try{isLoggedIn=!(theBusiness==null || theBusiness.getMessage().length()>0);}catch(Exception e){}
...
if(request.getParameter("code")==null || request.getParameter("code").length()<1){
	...
	String accessToken = readUrl("https://graph.facebook.com/oauth/access_token?"
    		...
    		"&redirect_uri=http://www.scenedipity.com/facebook_oauth").split("&")[0].replaceFirst("access_token=", "");
   ...
   // --- accessToken
   if(isLoggedIn){
	   %><span class = "message green">Choose the <b>facebook</b> page to which you'd like your information published: </span><%
	    }else{
   	%><span class="message red">Login to <b>scenedipity</b> above to link your accounts.</span><%
   }
   ...
   // see what pages this user can write to.
    ...
    if(isLoggedIn){
    	%><div style="width:100%; float:left; clear:both; text-align:center; margin-bottom:200px"><button class="g-button" id="save" type="button">link facebook &amp; scenedipity!</button></div><%
    }
